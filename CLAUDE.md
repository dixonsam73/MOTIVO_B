...
= **4 open: C-26, B-11, C-31 and B-34.** **C-59 was filed AND RESOLVED on 2026-09-02** — the only one that was a COVERAGE defect rather than missing capability or a metric gap, and the shortest-lived row in the register. **B-24 CLOSED ON 2026-08-30**, on its own
