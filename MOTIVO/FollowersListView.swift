...
// SCOPE: View-only ordering update for FollowersListView — sort followers alphabetically by resolved display name, using surname-first ordering when multiple name parts exist; fallback safely to userID; preserve all UI, swipe, loading, and navigation behavior.
